        ...
        check_in_button2.setOnClickListener {
            ...
            if ((check_in_radioButton3.isChecked == true || check_in_radioButton4.isChecked == true) && (check_in_radioButton5.isChecked == true || check_in_radioButton6.isChecked)) {
                if ((check_in_radioButton.isChecked == true || check_in_radioButton2.isChecked == true)) {
                    ...
                    builder.show()
                    if ((check_in_radioButton3.isChecked == true || check_in_radioButton4.isChecked == true) && (check_in_radioButton.isChecked == true || check_in_radioButton2.isChecked == true) && (check_in_radioButton5.isChecked == true || check_in_radioButton6.isChecked == true)) {
                        if ((check_in_radioButton4.isChecked == true) || (check_in_radioButton6.isChecked == true) || (check_in_radioButton2.isChecked == true)) {
                            val builder = AlertDialog.Builder(this)
