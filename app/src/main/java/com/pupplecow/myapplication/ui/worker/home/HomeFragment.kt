...
class HomeFragment:Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //home 화면 들어가자마자 toast 띄우기
        Toast.makeText(getActivity(), "블루투스 연결 성공했습니다.", Toast.LENGTH_SHORT).show()
...
//        home_text_news.text = "뉴스 제목입니다."
        ...
        val workspaceAdapter =
            ArrayAdapter(requireContext(), android.R.layout.simple_spinner_item, workspaceData)
        ...
        //작업선택 스피너
        val workAdapter =
            ArrayAdapter(requireContext(), android.R.layout.simple_spinner_item, workData)
...
//                            home_button_start.setEnabled(false)
        ...
        Handler(Looper.getMainLooper()).postDelayed({
            ShowTemperature.text = "40.3"
            ShowTemperature.setTextColor(Color.RED)
            val builder = AlertDialog.Builder(requireContext())
            builder.setTitle("주의!")
            builder.setMessage("현재 온도가 적정 온도 35도를 넘었습니다")
            builder.show()
