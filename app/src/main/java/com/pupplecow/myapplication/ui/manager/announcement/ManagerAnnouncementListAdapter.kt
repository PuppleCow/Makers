...
//
//class ManagerAnnouncementListAdapter (val context: Context,val itemClick: (Announcement) -> Unit):
...
//                    var item = snapshot.toObject(Announcement::class.java)
...
//            itemView.setOnClickListener { itemClick(Announcement) }
//
//        }
//
//    }
